...
- 🎯 Entry points to execute your program using `python -m <mytest>` or `$ mytest` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/sk7y/mytest/branch/main/graph/badge.svg?token=mytest_token_here)](https://codecov.io/gh/sk7y/mytest)
[![CI](https://github.com/sk7y/mytest/actions/workflows/main.yml/badge.svg)](https://github.com/sk7y/mytest/actions/workflows/main.yml)

Awesome mytest created by sk7y

## Install

from source
```bash
git clone https://github.com/sk7y/mytest mytest
cd mytest
make install
```
...
```bash
$ mytest run --port 8080
```

or

```bash
python -m mytest run --port 8080
```
...
```bash
❯ mytest --help
Usage: mytest [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ mytest create-user --help
Usage: mytest create-user [OPTIONS] USERNAME PASSWORD
...
```bash
mytest create-user admin admin --superuser
```
...
Run with `mytest run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `mytest create-user`.
...
-----------------------------------------------------
mytest/__init__.py              4      0   100%
mytest/app.py                  16      1    94%
mytest/cli.py                  21      0   100%
mytest/config.py                5      0   100%
mytest/db.py                   10      0   100%
mytest/models/__init__.py       0      0   100%
mytest/models/content.py       47      1    98%
mytest/routes/__init__.py      11      0   100%
mytest/routes/content.py       52     25    52%
mytest/routes/security.py      15      1    93%
mytest/routes/user.py          52     26    50%
mytest/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in mytest/default.toml.
